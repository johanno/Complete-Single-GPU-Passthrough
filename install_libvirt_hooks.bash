...
wget https://raw.githubusercontent.com/johanno/Complete-Single-GPU-Passthrough/master/etc_libvirt_hooks_qemu
wget https://raw.githubusercontent.com/johanno/Complete-Single-GPU-Passthrough/master/etc_libvirt_hooks_start.sh
wget https://raw.githubusercontent.com/johanno/Complete-Single-GPU-Passthrough/master/etc_libvirt_hooks_stop.sh
...
do
    ...
    middleID=arrB[0]
    lastID=arrB[1]
    str+="virsh nodedev-detach pci_0000_${frontID}_${middleID}_${lastID}\n"
    str2+="virsh nodedev-reattach pci_0000_${frontID}_${middleID}_${lastID}\n"
done
